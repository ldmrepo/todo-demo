        ...
        return (
            <div className="flex flex-col h-[800px]">
                ...
                <div className="grid grid-cols-8 gap-px bg-muted">
                    <div className="p-2 text-center text-sm font-medium bg-background">
                        시간
                    </div>
                    {days.map((day, index) => {
                        const isToday = isSameDay(day, today);
                        ...
                        <div className="bg-background">
                            {TIME_SLOTS.filter((_, i) => i % 2 === 0).map(
                                (slot, index) => (
                                    <div
                                        key={index}
                                        className="h-[60px] border-b pr-2 text-right text-sm text-muted-foreground"
                                    >
                                        {slot.hour}:00
                                    </div>
                                )
                            ...
                            return (
                                ...
                                >
                                    {TIME_SLOTS.map((slot, slotIndex) => {
                                        const todos = getTodosForTimeSlot(
                                            day,
                                            slot.hour,
                                            slot.minute
                                        );
            ...
            <div className="flex justify-between items-center">
                ...
                <h2 className="text-xl font-semibold">
                    ...
                    {calendarViewType === "week" &&
                        `${format(currentWeek, "yyyy년 M월 d일", {
                            locale: ko,
                        })} - ${format(addDays(currentWeek, 6), "M월 d일", {
                            locale: ko,
                        })}`}
                ...
                <div className="flex space-x-2">
                    <Button
                        size="sm"
                        variant={
                            calendarViewType === "month" ? "default" : "outline"
                        }
                    ...
                    <Button
                        size="sm"
                        variant={
                            calendarViewType === "week" ? "default" : "outline"
                        }
                    ...
                    <Button
                        size="sm"
                        variant={
                            calendarViewType === "day" ? "default" : "outline"
                        }
