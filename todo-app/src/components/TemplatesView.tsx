...
import { Priority, Todo, TodoTemplate } from "../db";
...
export function TemplatesView() {
    ...
    const [selectedTemplate, setSelectedTemplate] =
        useState<TodoTemplate | null>(null);
                        ...
                        >
                            ...
                            <div className="mt-4 border-t pt-3">
                                ...
                                <div className="flex flex-wrap gap-4 text-xs text-muted-foreground mb-2">
                                    ...
                                    {template.todoData.tags &&
                                        template.todoData.tags.length > 0 && (
                                            <div className="flex items-center">
                                                <span>
                                                    태그:{" "}
                                                    {template.todoData.tags.join(
                                                        ", "
                                                    )}
                                                </span>
                                            </div>
                                    ...
                                    {template.todoData.subtasks &&
                                        template.todoData.subtasks.length >
                                            0 && (
                                            <div className="flex items-center">
                                                <span>
                                                    하위작업:{" "}
                            ...
                            {/* 삭제 확인 다이얼로그 */}
                            <Dialog
                                open={confirmDelete === template.id}
                                onOpenChange={(open) =>
            ...
            <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
                <DialogContent className="sm:max-w-[600px]">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="border rounded-md p-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            value={
                                                selectedTemplate.todoData.text
                                            }
                                            onChange={(e) =>
                                                setSelectedTemplate({
                                                    ...selectedTemplate,
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleUpdateTemplate}>저장하기</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </div>
